%==============================================
% WorldTheory.pl for actor guitranslator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuguitranslator).	%%old version (deprecated)
actorobj(qatuguitranslator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor guitranslator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of guitranslator" ). 
...
%-------------------------------------------------
%  User static rules about guitranslator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
