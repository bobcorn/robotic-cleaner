%==============================================
% WorldTheory.pl for actor reqlamp
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatureqlamp).	%%old version (deprecated)
actorobj(qatureqlamp).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor reqlamp
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of reqlamp" ). 
...
%-------------------------------------------------
%  User static rules about reqlamp
%------------------------------------------------- 
/*
------------------------------------------------------------------------
