%==============================================
% WorldTheory.pl for actor reqclock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatureqclock).	%%old version (deprecated)
actorobj(qatureqclock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor reqclock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of reqclock" ). 
...
%-------------------------------------------------
%  User static rules about reqclock
%------------------------------------------------- 
/*
------------------------------------------------------------------------
