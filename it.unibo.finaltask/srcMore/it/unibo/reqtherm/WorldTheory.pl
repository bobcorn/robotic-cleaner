%==============================================
% WorldTheory.pl for actor reqtherm
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatureqtherm).	%%old version (deprecated)
actorobj(qatureqtherm).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor reqtherm
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of reqtherm" ). 
...
%-------------------------------------------------
%  User static rules about reqtherm
%------------------------------------------------- 
/*
------------------------------------------------------------------------
