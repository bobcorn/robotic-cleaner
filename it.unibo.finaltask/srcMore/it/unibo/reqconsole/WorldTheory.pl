%==============================================
% WorldTheory.pl for actor reqconsole
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatureqconsole).	%%old version (deprecated)
actorobj(qatureqconsole).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor reqconsole
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of reqconsole" ). 
...
%-------------------------------------------------
%  User static rules about reqconsole
%------------------------------------------------- 
/*
------------------------------------------------------------------------
